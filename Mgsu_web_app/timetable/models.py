...
class Timetable(models.Model): # Создаём новый класс, который будет служить для блога моделью, указывая все необходимые элементы.
   ...
   subject_type = models.CharField(max_length=30, blank=True, null=True)#Вид пары
   teacher = models.CharField(max_length=200, blank=True, null=True)#Преподаватель
   location = models.CharField(max_length=100, blank=True, null=True)#Место проведения
